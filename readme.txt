...
- `wlm_no_authorized_levels_message`: defaults to `<p>Sorry, you are not authorized to access any content. Please log in, check your subscription status, or contact us for more information.</p>`; shown when a user is not authorized for any WishList levels
- `wlm_no_authorized_content_message`: defaults to `<p>Sorry, you are not authorized to access any content. Please log in, check your subscription status, or contact us for more information.</p>`; shown when there are no pages available
